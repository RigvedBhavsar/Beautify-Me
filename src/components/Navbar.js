    ...
    const renderList = () => {
        if (state) {
            return [
                ...
                <li className="center"><Link to="/appointment">Appointment</Link></li>,
                // <li className="center" href="#about"><Link to="/about">About</Link></li>,
                // <li className="center" href="#contact"><Link to="/contact">Contact</Link></li>,
